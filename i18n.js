...
const I18N = {
  "zh-TW": {
    ...
    "index.vip.tag":          "🔐 需登入",
    "index.data.title":       "資料管理",
    "index.data.desc":        "清除舊資料、匯出 CSV（法遵 + 報表）",
    "index.data.tag":         "🔐 需登入",
    ...
    "book.consent":           "我已閱讀並同意以下個人資料蒐集告知事項。",
    "book.privacyToggle":     "詳細個資告知 ▾",
    "book.privacyTitle":      "個人資料蒐集告知",
    "book.privacyPurpose":    "蒐集目的：訪客身分確認、到訪報到管理、保衛室人員核對、緊急聯絡。",
    "book.privacyItems":      "蒐集項目：姓名、聯絡電話、Email、公司/單位、車牌、預計到訪時間、受訪員工、備註，及員工邀約時自願提供之 VIP 照片。",
    "book.privacyPeriod":     "保存期限與方式：資料儲存於本公司 Firebase 雲端資料庫，限本次到訪用途使用；保存期限為 6 個月，逾期由管理人員定期清除。",
    "book.privacyRights":     "您的權利：依個人資料保護法，您得隨時聯絡本公司行使查詢、閱覽、補正、刪除等權利。",
    "book.privacyContact":    "聯絡窗口：杰興工業 行政部 ｜ contact@jye-shing.com.tw",
    "book.privacyNote":       "未提供以上資料可能影響到訪安排，敬請見諒。",
    "book.submit":            "送出預約 →",
    ...
    // admin-data
    "data.title":             "資料管理",
    "data.loginTitle":        "管理員登入",
    "data.loginDesc":         "資料清除與匯出需登入 Google 帳號",
    "data.summaryTitle":      "📊 資料總覽",
    "data.summaryTotal":      "總筆數",
    "data.summaryEarliest":   "最早一筆",
    "data.summaryLatest":     "最新一筆",
    "data.cleanupTitle":      "🧹 清除舊資料",
    "data.cleanupDesc":       "保留期限到期後請定期手動清除（個資告知承諾 6 個月）",
    "data.cleanupSelectAge":  "保留多久之前的資料？",
    "data.cleanupAge3":       "3 個月以前",
    "data.cleanupAge6":       "6 個月以前",
    "data.cleanupAge12":      "12 個月以前",
    "data.cleanupCount":      "符合清除條件：{{count}} 筆",
    "data.cleanupBtn":        "🗑 刪除這 {{count}} 筆",
    "data.cleanupConfirm":    "確定刪除這 {{count}} 筆資料？此動作無法復原。",
    "data.cleanupDone":       "✅ 已刪除 {{count}} 筆",
    "data.cleanupFail":       "刪除失敗：{{msg}}",
    "data.exportTitle":       "📥 匯出 CSV",
    "data.exportDesc":        "依日期區間下載完整訪客資料；UTF-8 with BOM（Excel 可直接開啟）",
    "data.exportFrom":        "起始日",
    "data.exportTo":          "結束日",
    "data.exportBtn":         "下載 CSV",
    "data.exportEmpty":       "此區間沒有資料",
    "data.exportDone":        "已下載 {{count}} 筆",
    "data.exportFail":        "匯出失敗：{{msg}}"
  },
  ...
  "en": {
    ...
    "index.data.title":       "Data Management",
    "index.data.desc":        "Clean up old records and export CSV (compliance + reporting)",
    "index.data.tag":         "🔐 Sign-in required",
    ...
    "book.consent":           "I have read and consent to the personal data collection notice below.",
    "book.privacyToggle":     "Personal data notice ▾",
    "book.privacyTitle":      "Personal Data Collection Notice",
    "book.privacyPurpose":    "Purpose: verifying visitor identity, managing check-in, security desk reference, and emergency contact.",
    "book.privacyItems":      "Items collected: name, phone, email, company/organization, vehicle plate, expected visit time, host employee, notes, and the VIP photo voluntarily provided when staff issues an invitation.",
    "book.privacyPeriod":     "Retention: stored in our Firebase cloud database for this visit only; kept for up to 6 months and periodically cleared thereafter.",
    "book.privacyRights":     "Your rights: under personal data protection laws, you may contact us at any time to access, review, correct, or delete your data.",
    "book.privacyContact":    "Contact: JYE SHING Administrative Dept. | contact@jye-shing.com.tw",
    "book.privacyNote":       "Refusing to provide this information may affect arranging your visit.",
    "book.submit":            "Submit →",
    ...
    "data.loginTitle":        "Admin Sign-in",
    "data.loginDesc":         "Sign in to clean up or export visitor data",
    "data.summaryTitle":      "📊 Overview",
    "data.summaryTotal":      "Total records",
    "data.summaryEarliest":   "Earliest",
    "data.summaryLatest":     "Latest",
    "data.cleanupTitle":      "🧹 Clean up old data",
    "data.cleanupDesc":       "Periodically clear records past the retention period (6 months per privacy notice)",
    "data.cleanupSelectAge":  "Delete records older than:",
    "data.cleanupAge3":       "3 months",
    "data.cleanupAge6":       "6 months",
    "data.cleanupAge12":      "12 months",
    "data.cleanupCount":      "Records eligible: {{count}}",
    "data.cleanupBtn":        "🗑 Delete {{count}} records",
    "data.cleanupConfirm":    "Delete {{count}} records? This cannot be undone.",
    "data.cleanupDone":       "✅ Deleted {{count}} records",
    "data.cleanupFail":       "Delete failed: {{msg}}",
    "data.exportTitle":       "📥 Export CSV",
    "data.exportDesc":        "Download full visitor data for a date range; UTF-8 with BOM (Excel-friendly)",
    "data.exportFrom":        "From",
    "data.exportTo":          "To",
    "data.exportBtn":         "Download CSV",
    "data.exportEmpty":       "No records in this range",
    "data.exportDone":        "Downloaded {{count}} records",
    "data.exportFail":        "Export failed: {{msg}}"
  },
  ...
  "vi": {
    ...
    "index.data.title":       "Quản lý dữ liệu",
    "index.data.desc":        "Dọn dẹp dữ liệu cũ và xuất CSV (tuân thủ + báo cáo)",
    "index.data.tag":         "🔐 Cần đăng nhập",
    ...
    "book.consent":           "Tôi đã đọc và đồng ý với thông báo thu thập thông tin cá nhân bên dưới.",
    "book.privacyToggle":     "Thông báo về dữ liệu cá nhân ▾",
    "book.privacyTitle":      "Thông báo thu thập thông tin cá nhân",
    "book.privacyPurpose":    "Mục đích: xác minh danh tính khách, quản lý check-in, đối chiếu với bảo vệ, và liên hệ khẩn cấp.",
    "book.privacyItems":      "Thông tin thu thập: họ tên, điện thoại, email, công ty/đơn vị, biển số xe, thời gian dự kiến, người tiếp, ghi chú, và ảnh VIP do nhân viên tự nguyện cung cấp khi mời.",
    "book.privacyPeriod":     "Lưu trữ: lưu trên hệ thống Firebase đám mây của công ty, chỉ dùng cho lần thăm này; lưu trong 6 tháng và sẽ được xoá định kỳ sau đó.",
    "book.privacyRights":     "Quyền của bạn: theo luật bảo vệ dữ liệu cá nhân, bạn có thể liên hệ với công ty bất cứ lúc nào để xem, sửa, hoặc xoá dữ liệu.",
    "book.privacyContact":    "Liên hệ: Phòng Hành chính JYE SHING | contact@jye-shing.com.tw",
    "book.privacyNote":       "Từ chối cung cấp thông tin có thể ảnh hưởng đến việc sắp xếp chuyến thăm.",
    "book.submit":            "Gửi →",
    ...
    "data.loginTitle":        "Đăng nhập quản trị",
    "data.loginDesc":         "Đăng nhập Google để dọn dẹp hoặc xuất dữ liệu khách",
    "data.summaryTitle":      "📊 Tổng quan",
    "data.summaryTotal":      "Tổng số bản ghi",
    "data.summaryEarliest":   "Sớm nhất",
    "data.summaryLatest":     "Mới nhất",
    "data.cleanupTitle":      "🧹 Dọn dẹp dữ liệu cũ",
    "data.cleanupDesc":       "Hãy dọn dẹp định kỳ sau thời gian lưu trữ (6 tháng theo thông báo riêng tư)",
    "data.cleanupSelectAge":  "Xoá bản ghi cũ hơn:",
    "data.cleanupAge3":       "3 tháng",
    "data.cleanupAge6":       "6 tháng",
    "data.cleanupAge12":      "12 tháng",
    "data.cleanupCount":      "Bản ghi đủ điều kiện: {{count}}",
    "data.cleanupBtn":        "🗑 Xoá {{count}} bản ghi",
    "data.cleanupConfirm":    "Xoá {{count}} bản ghi? Không thể hoàn tác.",
    "data.cleanupDone":       "✅ Đã xoá {{count}} bản ghi",
    "data.cleanupFail":       "Xoá thất bại: {{msg}}",
    "data.exportTitle":       "📥 Xuất CSV",
    "data.exportDesc":        "Tải dữ liệu khách theo khoảng thời gian; UTF-8 với BOM (mở được bằng Excel)",
    "data.exportFrom":        "Từ",
    "data.exportTo":          "Đến",
    "data.exportBtn":         "Tải CSV",
    "data.exportEmpty":       "Không có bản ghi trong khoảng này",
    "data.exportDone":        "Đã tải {{count}} bản ghi",
    "data.exportFail":        "Xuất thất bại: {{msg}}"
  }
};
